...
export async function POST() {
  const customerName  = 'Joel Test'
  const customerEmail = 'gprofessionalservices.info@gmail.com'
  const packageName   = 'Test LLC WY'
  const amountTotal   = '299'
  const orderRef      = 'TEST-001'
