 ...
 * Used by: webhook, admin resend-welcome.
 * Single source of truth — do not duplicate this function in route files.
 */
export function buildWelcomeEmailHtml(opts: {
  ...
  const amount   = opts.amountTotal != null ? `$${opts.amountTotal} USD` : '—'
  const orderRef = opts.orderRef ?? '—'
    ...
    <div class="wrapper">
      <div class="email">
        ...
        <div class="hero">
          ...
          <div class="hero-sub">
            Hemos recibido tu orden para <strong style="color:#ffffff">${opts.companyName}</strong>${opts.stateName ? ` en el estado de <strong style="color:#ffffff">${opts.stateName}</strong>` : ''}. Nuestro equipo ya está trabajando en tu caso.
          </div>
        </div>
            ...
            <div class="order-top">
              <div style="display:flex;justify-content:space-between;gap:12px;align-items:flex-start;flex-wrap:wrap">
                <div>
                  ...
                  <div class="order-meta">Ref. ${orderRef}${opts.stateName ? ` &nbsp;·&nbsp; ${opts.stateName}` : ''}</div>
                </div>
        ...
        <div class="section">
          ...
          <div class="timeline">
            ...
            <div class="step">
              ...
              <div class="step-text">Presentaremos tu formación oficialmente${opts.stateName ? ` en el estado de ${opts.stateName}` : ''}.</div>
            </div>
            <div class="step">
